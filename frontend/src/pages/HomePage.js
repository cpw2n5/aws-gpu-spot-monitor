      ...
      <Container maxW={'3xl'}>
        ...
        >
          <Heading
            ...
            lineHeight={'110%'}
          >
            AWS GPU Spot Instance <br />
            <Text as={'span'} color={'blue.400'}>
              Monitor & Manager
            </Text>
          </Heading>
          <Text color={'gray.500'}>
            Optimize your GPU workloads with real-time spot price monitoring,
            automated instance management, and seamless Folding@Home integration.
            Save costs and contribute to scientific research with our comprehensive
            management platform.
          </Text>
          <Stack
            direction={'column'}
      ...
      <Box bg={useColorModeValue('gray.50', 'gray.900')} p={10}>
        <Container maxW={'6xl'}>
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10}>
            <Feature
              icon={<Icon as={SpotPriceIcon} w={10} h={10} />}
              title={'Spot Price Monitoring'}
              text={
                'Track real-time spot prices across all AWS regions and instance types. Set price thresholds and receive alerts when prices drop below your target.'
              }
            />
            <Feature
              icon={<Icon as={InstanceIcon} w={10} h={10} />}
              title={'Instance Management'}
              text={
                'Deploy, monitor, and terminate GPU instances with ease. Automated instance management based on your price thresholds and workload requirements.'
              }
            />
            <Feature
              icon={<Icon as={FoldingIcon} w={10} h={10} />}
              title={'Folding@Home Integration'}
              text={
                'Seamlessly integrate with Folding@Home to contribute to scientific research. Monitor your contribution stats and optimize your folding performance.'
              }
            />
          </SimpleGrid>
        </Container>
 ...
 * Spot price icon
 */
const SpotPriceIcon = createIcon({
  displayName: 'SpotPriceIcon',
  viewBox: '0 0 24 24',
  path: (
    <path
      fill="currentColor"
 ...
 * Instance icon
 */
const InstanceIcon = createIcon({
  displayName: 'InstanceIcon',
  viewBox: '0 0 24 24',
  path: (
    <path
      fill="currentColor"
 ...
 * Folding icon
 */
const FoldingIcon = createIcon({
  displayName: 'FoldingIcon',
  viewBox: '0 0 24 24',
  path: (
    <path
      fill="currentColor"
